...
-- Running upgrade fcd2b46431a0 -> a721d3c59cef

ALTER TABLE api_key ADD COLUMN role VARCHAR;

UPDATE alembic_version SET version_num='a721d3c59cef' WHERE alembic_version.version_num = 'fcd2b46431a0';
